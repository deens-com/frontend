...
class AccountTripsCompletedComponent extends Component {
  ...
  render() {
    ...
    ordered_completed_trips = ordered_completed_trips.sort(
      (a, b) => new Date(b.beginDate.iso) - new Date(a.beginDate.iso),
    );
    return (
      <section>
        <Page topPush>
...
const mapDispatchToProps = dispatch => bindActionCreators(account_actions, dispatch);
