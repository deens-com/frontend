          ...
          <HorizontalSpan>
            <BoldH4>Bio :</BoldH4>
            {
              this.state.isBiographyEditable
                ?
                <Input style={{minWidth:'35em'}} placeholder='Biography' name='biography' value={this.state.biography} onChange={this.handleInputChange} />
                :
          ...
          <HorizontalSpan>
            <BoldH4>Username :</BoldH4>
            {
              this.state.isUsernameEditable
                ?
                <Input style={{minWidth:'35em'}} placeholder='Username' name='username' value={this.state.username} onChange={this.handleInputChange} />
                :
          ...
          <HorizontalSpan>
            <BoldH4>Email :</BoldH4>
            {
              this.state.isEmailEditable
                ?
                <Input style={{minWidth:'35em'}} placeholder='Email' name='email' value={this.state.email} onChange={this.handleInputChange} />
                :
