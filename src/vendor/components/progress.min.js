      ...
      e.each(function() {
        ...
        (s = {
          ...
          read: {
            ...
            settings: function() {
              !1 !== r.total &&
                (s.debug("Current total set in settings", r.total),
                s.set.total(r.total)),
                !1 !== r.value &&
          ...
          set: {
            ...
            active: function(e) {
              (e = e || r.text.active),
                ...
                s.remove.error(),
                s.remove.success(),
                (e = r.onLabelUpdate("active", e, s.value, s.total)) &&
                  s.set.label(e),
                s.bind.transitionEnd(function() {
            ...
            warning: function(e) {
              (e = e || r.text.warning),
                ...
                s.remove.error(),
                s.complete(),
                (e = r.onLabelUpdate("warning", e, s.value, s.total)) &&
                  s.set.label(e),
                s.bind.transitionEnd(function() {
            ...
            error: function(e) {
              (e = e || r.text.error),
                ...
                s.remove.warning(),
                s.complete(),
                (e = r.onLabelUpdate("error", e, s.value, s.total)) &&
                  s.set.label(e),
                s.bind.transitionEnd(function() {
