      ...
      return (
        e.each(function() {
          var n,
            ...
            c,
            l = E.isPlainObject(S)
              ? E.extend(!0, {}, E.fn.modal.settings, S)
          ...
          (c = {
            ...
            create: {
              dimmer: function() {
                var e = {
                  ...
                  i = E.extend(!0, e, l.dimmerSettings);
                E.fn.dimmer !== P
            ...
            refreshModals: function() {
              (t = v.siblings(d.modal)), (n = t.add(v));
            },
            attachEvents: function(e, i) {
              var n = E(e);
              (i = E.isFunction(c[i]) ? c[i] : c.toggle),
                0 < n.length
                  ? (c.debug("Attaching modal events to element", e, i),
                    n.off(g).on("click" + g, i))
            ...
            event: {
              ...
              click: function(e) {
                if (l.closable) {
                  var i = 0 < E(e.target).closest(d.modal).length,
                    n = E.contains(N.documentElement, e.target);
                  !i &&
                    n &&
                    c.is.active() &&
              ...
              debounce: function(e, i) {
                clearTimeout(c.timer), (c.timer = setTimeout(e, i));
              },
              keyboard: function(e) {
                27 == e.which &&
                  (l.closable
            ...
            hideModal: function(e, i) {
              (e = E.isFunction(e) ? e : function() {}),
                c.debug("Hiding modal"),
                !1 !== l.onHide.call(y, E(this))
                  ? (c.is.animating() || c.is.active()) &&
                    (l.transition &&
                    E.fn.transition !== P &&
                    v.transition("is supported")
                      ? (c.remove.active(),
                        v.transition({
                          ...
                          onComplete: function() {
                            l.onHidden.call(y), c.restore.focus(), e();
                          }
                        }))
                      : c.error(f.noTransition))
            ...
            hideAll: function(e) {
              var i = n.filter("." + u.active + ", ." + u.animating);
              (e = E.isFunction(e) ? e : function() {}),
                0 < i.length &&
                  (c.debug("Hiding all visible modals"),
                  c.hideDimmer(),
                  i.modal("hide modal", e));
            },
            hideOthers: function(e) {
              var i = t.filter("." + u.active + ", ." + u.animating);
              (e = E.isFunction(e) ? e : function() {}),
                0 < i.length &&
                  (c.debug("Hiding other modals", t),
                  i.modal("hide modal", e, !0));
            },
            others: {
              active: function() {
            ...
            add: {
              keyboardShortcuts: function() {
                c.verbose("Adding keyboard shortcuts"),
                  H.on("keyup" + g, c.event.keyboard);
              }
            },
            save: {
              focus: function() {
                0 < E(N.activeElement).closest(v).length ||
            ...
            remove: {
              ...
              screenHeight: function() {
                c.debug("Removing page height"), F.css("height", "");
              },
              keyboardShortcuts: function() {
                c.verbose("Removing keyboard shortcuts"), H.off("keyup" + g);
              },
              scrolling: function() {
            ...
            cacheSizes: function() {
              ...
              (c.cache !== P && 0 === i) ||
                ((c.cache = {
                  ...
                  contextHeight:
                    "body" == l.context ? E(j).height() : o.height()
                }),
            ...
            can: {
              fit: function() {
                var e = c.cache.contextHeight,
                  i = c.cache.contextHeight / 2,
                  n = c.cache.topOffset,
                  t = c.cache.scrollHeight,
                  o = c.cache.height,
                  a = l.padding;
                return o < t ? i + n + t + a < e : o + 2 * a < e;
              }
            },
            is: {
              active: function() {
              ...
              screenHeight: function() {
                c.can.fit()
                  ...
                  : (c.debug(
                    ...
                    F.css("height", c.cache.height + 2 * l.padding));
              },
              active: function() {
                v.addClass(u.active);
              },
              scrolling: function() {
                o.addClass(u.scrolling), v.addClass(u.scrolling);
              },
              type: function() {
                c.can.fit()
            ...
            setting: function(e, i) {
              if ((c.debug("Changing setting", e, i), E.isPlainObject(e)))
                E.extend(!0, l, e);
              else {
                if (i === P) return l[e];
                E.isPlainObject(l[e]) ? E.extend(!0, l[e], i) : (l[e] = i);
              }
            },
                ...
                "string" == typeof t &&
                  ...
                  E.each(t, function(e, i) {
                    ...
                    if (E.isPlainObject(r[n]) && e != o) r = r[n];
                      ...
                      if (!E.isPlainObject(r[i]) || e == o)
                        return r[i] !== P && (a = r[i]), !1;
                      r = r[i];
                    }
                  })),
                E.isFunction(a) ? (n = a.apply(i, e)) : a !== P && (n = a),
                E.isArray(C)
                  ? C.push(n)
                  : C !== P ? (C = [C, n]) : n !== P && (C = n),
                a
            ...
            O
              ? (k === P && c.initialize(), c.invoke(T))
              : (k !== P && k.invoke("destroy"), c.initialize());
        }),
        C !== P ? C : this
      );
    }),
