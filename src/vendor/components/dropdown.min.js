        ...
        H.each(function(n) {
          ...
          (m = {
              ...
              mouseEvents: function() {
                m.verbose("Binding mouse events"),
                  ...
                  m.is.searchSelection()
                    ...
                    : ("click" == h.on
                        ? S.on("click" + x, w.icon, m.event.icon.click).on(
                            "click" + x,
                            m.event.test.toggle
                          )
                        : "hover" == h.on
                      ...
                      : t == p.rightArrow
                        ? (v && !s && n.first().addClass(g.active),
                          s &&
                            ...
                            c
                              ? u
                                ? d ? n.removeClass(g.active) : m.focusSearch()
                                : r
            ...
            action: {
              ...
              hide: function(e, t, n) {
                m.set.value(t, e), m.hideAndClear();
              }
            },
            get: {
              id: function() {
              ...
              selectionCount: function() {
                ...
                return m.is.multiple()
                  ? X.isArray(e) ? e.length : 0
                  : "" !== m.get.value() ? 1 : 0;
              },
              transition: function(e) {
                return "auto" == h.transition
                  ? m.is.upward(e) ? "slide up" : "slide down"
                  : h.transition;
              },
              userValues: function() {
                var e = m.get.values();
              ...
              values: function() {
                ...
                return "" === e
                  ...
                  : !m.has.selectInput() && m.is.multiple()
                    ? "string" == typeof e ? e.split(h.delimiter) : ""
                    : e;
              },
              ...
              item: function(i, a) {
                ...
                return (
                  (i =
                    i !== J
                      ? i
                      : m.get.values() !== J ? m.get.values() : m.get.text()),
            ...
            add: {
              ...
              value: function(e, t, n) {
                ...
                m.has.value(e)
                  ...
                  : "" !== e
                    ? (X.isArray(a)
                        ? ((i = a.concat([e])), (i = m.get.uniqueArray(i)))
                        : (i = [e]),
                      m.has.selectInput()
                        ? m.can.extendSelect() &&
              ...
              openDownward: function(e) {
                ...
                return (
                  ...
                  (t = {
                    ...
                    ? (m.verbose("Dropdown can fit in context downward", t),
                      (a = !0))
                    : t.below || t.above
                      ? (m.verbose(
