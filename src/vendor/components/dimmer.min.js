      ...
      return (
        b.each(function() {
          var a,
            ...
            d = "module-" + e,
            c = b.selector || "",
            u = "ontouchstart" in D.documentElement ? "touchstart" : "click",
            l = T(this),
            f = this,
            g = l.data(d);
          (s = {
            ...
            instantiate: function() {
              s.verbose("Storing instance of module", s), (g = s), l.data(d, g);
            },
            destroy: function() {
            ...
            bind: {
              events: function() {
                "hover" == r.on
                  ...
                  : "click" == r.on && i.on(u + o, s.toggle),
                  s.is.page() &&
                    (s.debug("Setting as a page dimmer", i),
                    s.set.pageDimmer()),
                  s.is.closable() &&
                    (s.verbose("Adding dimmer close event", a),
                    i.on(u + o, n.dimmer, s.event.click));
              }
            },
            unbind: {
              events: function() {
                l.removeData(d), i.off(o);
              }
            },
            event: {
              click: function(e) {
            ...
            setting: function(e, i) {
              if ((s.debug("Changing setting", e, i), T.isPlainObject(e)))
                T.extend(!0, r, e);
              else {
                if (i === N) return r[e];
                ...
                "string" == typeof t &&
                  ...
                  T.each(t, function(e, i) {
                    ...
                    if (T.isPlainObject(r[n]) && e != o) r = r[n];
                      ...
                      if (r[n] !== N) return (a = r[n]), !1;
                      if (!T.isPlainObject(r[i]) || e == o)
                        return (
                          r[i] !== N ? (a = r[i]) : s.error(m.method, t), !1
                        );
                      r = r[i];
                    }
                  })),
                T.isFunction(a) ? (n = a.apply(i, e)) : a !== N && (n = a),
                T.isArray(h)
                  ? h.push(n)
                  : h !== N ? (h = [h, n]) : n !== N && (h = n),
                a
            ...
            w
              ? (g === N && s.initialize(), s.invoke(C))
              : (g !== N && g.invoke("destroy"), s.initialize());
        }),
        h !== N ? h : this
      );
    }),
